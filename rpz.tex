...
%\include{00-abstract}
\thispagestyle{empty}
\include{course-scheme/00-abstract}
\thispagestyle{empty}
\tableofcontents
\frontmatter

%\include{10-defines}
\include{course-scheme/abbrev}

\include{course-scheme/intro}

\mainmatter % это включает нумерацию глав и секций в документе ниже

\include{course-scheme/analiz-syncro}
\clearpage
\include{course-scheme/struct-design}
\clearpage
\include{course-scheme/11-release}
\clearpage
...
\include{course-scheme/81-biblio}
...
\setcounter{page}{24}
%
\include{course-scheme/appendix1}
\clearpage
\include{course-scheme/appendix2}
\clearpage
\include{course-scheme/appendix3}
\clearpage
