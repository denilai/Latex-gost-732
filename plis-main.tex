...
%\include{00-abstract}
\thispagestyle{empty}
\include{course-plis/00-abstract}
\thispagestyle{empty}
\tableofcontents
\frontmatter

%\include{10-defines}
\include{course-plis/abbrev}

\include{course-plis/intro}

\mainmatter % это включает нумерацию глав и секций в документе ниже

\include{course-plis/lab1}
\clearpage
\include{course-plis/lab2}
\clearpage
\include{course-plis/lab3}
\clearpage
\include{course-plis/lab4}
\clearpage
\include{course-plis/lab5}
\clearpage
...
%\setcounter{page}{24}
%
\include{course-plis/appendix1}
\clearpage
\include{course-plis/appendix2}
\clearpage
%\include{course-plis/appendix3}
%\clearpage
